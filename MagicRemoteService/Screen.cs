...
namespace MagicRemoteService {
	internal class Screen {
		private static readonly object oUpdateScreenLock = new object();
		...
		public static System.Drawing.Rectangle DesktopBounds {
			get {
				lock(Screen.oUpdateScreenLock) {
					return Screen.recDesktopBounds;
				}
			}
		}
		...
		private static void UpdateScreen() {
			...
			lock(Screen.oUpdateScreenLock) {
				...
				Screen.recDesktopBounds = new System.Drawing.Rectangle();
